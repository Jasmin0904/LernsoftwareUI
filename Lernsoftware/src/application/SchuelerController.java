...
public class SchuelerController {
    ...
    @FXML
    void viewDeutsch(ActionEvent event) throws IOException {
    	Main m = new Main();
		m.changeScene("BSueTDeutsch.fxml");
    }
    
    @FXML
    void viewEnglisch(ActionEvent event) throws IOException {
    	Main m = new Main();
		m.changeScene("BSueTEnglisch.fxml");
    }
    
    @FXML
    void viewMathe(ActionEvent event) throws IOException {
    	Main m = new Main();
