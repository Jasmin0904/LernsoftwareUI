...
public class BSueVKlasse2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        mediaVideo = new Media(new File("src/resources/surfing.mp4").toURI().toString());
        ...
        ivRestart.setFitWidth(20);
        ivRestart.setFitHeight(20);
        ...
        ivExit.setFitHeight(20);
        ivExit.setFitWidth(20);
    ...
    void goTo(ActionEvent event) throws IOException {
		...
		if(menuKleinkinder.isVisited()) {
			...
			m.changeScene("BSueVKlasse2.fxml");
		}
